...
const opTypeLabelMap = computed<Record<string, string>>(() => ({
  ...
  'ha.write_guard.reject': t('system.audit.opHaWriteGuardReject'),
  'ops.system.ntp.sync': t('system.audit.opOpsSystemNtpSync'),
  'ops.system.ntp': t('system.audit.opOpsSystemNtp'),
  'security.alert': t('system.audit.opSecurityAlert'),
  'security.violation': t('system.audit.opSecurityViolation'),
  'security.error': t('system.audit.opSecurityError'),
  'auth.password.reset': t('system.audit.opAuthPwdReset'),
  'auth.password.change': t('system.audit.opAuthPwdChange'),
  'auth.super_admin.password.change': t('system.audit.opAuthSuperAdminPwdChange'),
  'auth.api_key.update': t('system.audit.opAuthApiKeyUpdate'),
  'cluster.command.dispatch': t('system.audit.opClusterCommandDispatch'),
  'cluster.member.leave': t('system.audit.opClusterMemberLeave'),
  'cluster.failover.plan.create': t('system.audit.opClusterFailoverPlanCreate'),
  'ha.drill.dry_run': t('system.audit.opHaDrillDryRun'),
  'ha.failback.allow': t('system.audit.opHaFailbackAllow'),
  'lease.decline': t('system.audit.opLeaseDecline'),
  'lease.conflict_detected': t('system.audit.opLeaseConflictDetected'),
  'policy.draft.create': t('system.audit.opPolicyDraftCreate'),
  'policy.draft.update': t('system.audit.opPolicyDraftUpdate'),
  'policy.draft.delete': t('system.audit.opPolicyDraftDelete'),
  'policy.draft.publish': t('system.audit.opPolicyDraftPublish'),
  'policy.version.publish': t('system.audit.opPolicyVersionPublish'),
  'policy.version.rollback': t('system.audit.opPolicyVersionRollback'),
  'policy.rule.create': t('system.audit.opPolicyRuleCreate'),
  'policy.rule.update': t('system.audit.opPolicyRuleUpdate'),
  'policy.rule.delete': t('system.audit.opPolicyRuleDelete'),
  'core.tools.migration.import': t('system.audit.opToolsMigrationImport'),
  'core.tools.migration.rollback': t('system.audit.opToolsMigrationRollback')
}));
